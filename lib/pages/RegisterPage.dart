...
import 'package:lapor_book/component/Input_Widget.dart';
import 'package:lapor_book/component/Validators.dart';
        ...
        child: _isLoading
            ...
            : SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 80),
                    Text('Register Disini', style: TextStyle(color: Colors.red[600],fontSize: 40,fontWeight: FontWeight.bold) ,),
                    Container(
                      child: const Text(
